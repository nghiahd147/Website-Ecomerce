...
import ListProductSearch from "../../../components/User/ListProducts/ListProductSearch";

const Search = () => {
    const params = useParams();
    const nameSearch = params.id;
        ...
        <div className="w-full flex">
            <div className="w-1200 mx-auto mt-12 grid grid-rows-1 grid-cols-1 gap-6">
                ...
                <div className="flex justify-between items-center border-gray-300 border-2 p-3 mb-8">
                    ...
                    <CiViewList
                        size={26}
                        className="hover:cursor-pointer shop__icon"
                    />
                    </div>
                    <div className="flex items-center">
                    <span className="text-base mr-2">Sort by</span>
                    <select
                        className="text-base border-2 rounded-sm cursor-pointer outline-none"
                        name=""
                        id=""
                ...
                <div className="grid grid-rows-1 grid-cols-4 gap-10">
                    <ListProductSearch nameSearch={nameSearch} nameOption={nameOption} />
                </div>
                </div>
            </div>
        </div>
